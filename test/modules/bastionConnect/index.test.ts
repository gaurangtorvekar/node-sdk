...
const DEFAULT_CONFIG: BastionSignerOptions = {
	...
	// rpcUrl: process.env.RPC_URL1 || "", //mumbai - works
	// chainId: 80001,
	// rpcUrl: process.env.RPC_URL2 || "", // arb-goerli - works
	// chainId: 421613,
	// rpcUrl: process.env.RPC_URL3 || "", // scroll - Error "message":"Unexpected token C in JSON at position 0"}
	// chainId: 534353,
	// rpcUrl: process.env.RPC_URL4 || "", // linea - works
	// chainId: 59140,
	rpcUrl: process.env.RPC_URL5 || "", // base-goerli
	chainId: 84531,
	// rpcUrl: process.env.RPC_URL6 || "", // optimism-goerli - Error: AA25 invalid account nonce
	// chainId: 421613,
