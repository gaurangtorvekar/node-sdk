...
describe("SmartWallet", () => {
	...
	describe("setupSmartAccount", () => {
		...
		it.skip("should return expected sender address by calling getSmartAccountAddress", async () => {
			...
			// Create a provider
			const provider = new ethers.providers.JsonRpcProvider(DEFAULT_CONFIG.rpcUrl);

			// Connect the wallet to the provider
			const walletConnected = wallet.connect(provider);

			// console.log(walletConnected);
			console.log("Geting address = ", await walletConnected.getAddress());
			console.log(walletConnected.signer);
